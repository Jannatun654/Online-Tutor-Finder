<%@ Page Title="Registation Page ||Online Private Tutors Finder System" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="registationPage.aspx.cs" Inherits="Online_Private_Tutors_Finder_System.registation" %>
	...
	<div class="row m-2">
		<div class="col-md-6 m-auto card"> 
          ...
          <form>
            ...
            <div class="form-group">
				<asp:TextBox ID="txtPPassword" class="form-control" placeholder="Password" required="" runat="server"></asp:TextBox>
            </div>
             <div class="text-center pt-2 pb-1">
				<asp:Button ID="ParentRegister" class="btn btn-primary btn-block" runat="server" Text="Register" OnClick="ParentRegister_Click" />
              </div>
          </form>
        </div>
